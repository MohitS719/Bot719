    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        try:
            ...
            if check and check.group(0).lower() == to_fix.lower():
                update.effective_message.reply_to_message.reply_text("Hey Lawda, {} is trying to make "
        ...
        if len(text) >= telegram.MAX_MESSAGE_LENGTH:
            update.effective_message.reply_text("Itna bada msg na me allow karunga na tg!")
        elif text:
