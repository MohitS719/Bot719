...
def check_flood(bot: Bot, update: Update) -> str:
    ...
    try:
        ...
        msg.reply_text("dont disturb others Nikl bsdk pehli fursat me...")

        return "<b>{}:</b>" \
               "\n#BANNED" \
               "\n<b>Lawda:</b> {}" \
               "\nMadrchod Flood kar rha tha group me.".format(html.escape(chat.title),
...
def set_flood(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if len(args) >= 1:
        ...
        if val == "off" or val == "no" or val == "0":
            sql.set_flood(chat.id, 0)
            message.reply_text("I will no longer dismiss those who flood.(it is recommended to use it bc)")
            ...
            message.reply_text("I don't understand what you're saying .... Either use the number or use Yes-No nhi to machuda")
...
def flood(bot: Bot, update: Update):
    ...
    if limit == 0:
        ...
        update.effective_message.reply_text(
            " {} machodunga jo awkat se jyada msgs bhejega madrchod".format(limit))
