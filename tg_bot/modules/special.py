...
def getlink(bot: Bot, update: Update, args: List[int]):
    if args:
        ...
        update.effective_message.reply_text("You don't seem to be referring to a chat! chutiya samja h kya bc?")
    ...
    if bot_member.can_invite_users:
        ...
        update.effective_message.reply_text("I don't have access to the invite link!ye kya baat hui yaar")
